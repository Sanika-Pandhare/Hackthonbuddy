      ...
      <main className="hackathon-main">
          ...
          <div className="header-right">
            ...
            <div className="header-profile">
              ...
              <div className="profile-info">
                <strong>Sanika Haridas Pandhare</strong>
        ...
        <div className="results-header">
          ...
          <div>
            ...
            <span>
              {filteredHackathons.length} opportunities found
            </span>
          </div>
            ...
            filteredHackathons.map((hackathon) => (
              ...
              >
                ...
                <div className="card-top">
                  ...
                  <div
                    className={`hackathon-icon ${hackathon.color}`}
                  >
                    {hackathon.icon}
                  </div>
                ...
                <div className="card-actions">
                  ...
                  <button
                    className={
                      registered.includes(hackathon.id)
      ...
      {selectedHackathon && (
        ...
        >
          ...
          >
            ...
            <div
              className={`modal-icon ${selectedHackathon.color}`}
            >
            ...
            <button
              className={
                registered.includes(selectedHackathon.id)
                  ? "modal-register registered"
                  : "modal-register"
              }
              onClick={() =>
                handleRegister(selectedHackathon.id)
              }
            >
              {registered.includes(selectedHackathon.id)
                ? "✓ You are Registered"
